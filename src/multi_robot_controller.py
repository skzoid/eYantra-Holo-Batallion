...
class fsm(Node):
    def __init__(self , exec):
        ...
        self.D1_bookings = {0:[[1215,1215],[1305,1215],[1155,1215],[1227,1215],[1203,1225]] , 1:[[1260,1215],[1224,1215],[1212,1215],[1224,1215]]}
        self.D2_bookings = {0:[[820,2017.5],[900,2017.5],[814,2017.5],[832,2017.5],[806,2017.5]] , 1:[[860,2037.5],[817,2017.5],[829,2017.5],[811,2017.5]]}
        self.D3_bookings = {0:[[1616,2017.5],[1696,2017.5],[1610,2017.5],[1628,2017.5],[1604,2017.5]] , 1:[[1656,2017.5],[1613,2017.5],[1625,2017.5],[1607,2017.5]]}
        self.num_D1 = 0
        self.num_D2 = 0
        self.num_D3 = 0
        self.D1_idx = 0
    ...
    def update_0(self , bot_id = 0 , thres = 210):
        if(self.state_idx_0 >= len(self.states_order)):
            ...
            if self.drop_allocated[self.assignments[bot_id]][0] == 0:
                ...
                drop_zone,yaw = self.give_drop_location(bot_id , self.assignments[bot_id] , thres - 25.0)
            ...
            if(self.time_0_1 is None):
                ...
                if self.drop_allocated[self.assignments[bot_id]][0] == 0:
                    ...
                    self.arm_control(bot_id , 40 , 10)
                elif self.drop_allocated[self.assignments[bot_id]][0] == 1:
                    self.arm_control(bot_id , 75 , 40)
                ...
                if self.drop_allocated[self.assignments[bot_id]][0] == 0:
                    ...
                    self.arm_control(bot_id , 120 , 40)
    ...
    def update_2(self , bot_id = 2 , thres = 210):
        ...
        if(self.state_idx_2 >= len(self.states_order)):
            ...
            if(self.time_2_1 is None):
                ...
                self.arm_control(bot_id , 80 , 5)
                self.arm_control(bot_id , 90 , 5)
                self.arm_control(bot_id , 100 , 5)
                self.state_idx_2 += 1
                self.time_2_1 = None
                self.time_2_2 = None
            ...
            if(self.time_2_1 is None):
                ...
                if self.drop_allocated[self.assignments[bot_id]][0] == 0:
                    ...
                    self.arm_control(bot_id , 130 , 40)
                self.state_idx_2 += 1
                self.time_2_1 = None
                self.time_2_2 = None
    ...
    def update_4(self , bot_id = 4 , thres = 210):
        if(self.state_idx_4 >= len(self.states_order)):
            ...
            if(self.time_4_1 is None):
                ...
                self.arm_control(bot_id , 130 , 10)
